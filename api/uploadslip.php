...
$id = $_POST['nf_ref_id'];
$radio = $_POST['radio'];
$sql = "UPDATE tb_order SET logis_method ='$radio', pay_date = '$today' WHERE order_id = '$id' ";
...
//เพิ่มเข้าฐานข้อมูล
$sqluplado = "UPDATE tb_order SET pay_slip = '$image_name' WHERE order_id = '$id'";
...
if($qr || $qr1){echo "<script> window.location = '../showorder.php'</script>";}
