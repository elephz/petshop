    ...
    <div class="container" id="section1">
        <div class="bs-example mx-auto">
            <ul class="nav nav-tabs ">
                ...
                <li class="nav-item">
                    <a href="#<?php echo "p".$row['product_type_id'] ?>" class="nav-link <?php if($i ==1){echo "active" ;} ?>" data-toggle="tab"><?php echo $row['product_type_name'] ?></a>
                </li>
                <?php $i++; } ?>
            </ul>
        </div>
...
<div class="container">
    ...
    <?php $i = 1;  while($row2 = mysqli_fetch_assoc($qr2)){ ?>
        <div class="tab-pane fade show <?php if($i ==1){echo "active" ;} ?>" id="<?php echo "p".$row2['product_type_id'] ?>">
            <div class="grid-area">
            <?php
